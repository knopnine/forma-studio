        ...
        <div className="relative z-10 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="btn-secondary text-xs py-2 px-3 min-h-[40px] flex items-center gap-1"
            ...
            {restTimer.isRunning ? (
              <button
                ...
                className="btn-secondary text-xs p-2 min-w-[40px] min-h-[40px] flex items-center justify-center"
              ...
              <button
                ...
                className="btn-primary text-xs p-2 min-w-[40px] min-h-[40px] flex items-center justify-center"
                title="Resume rest timer"
            ...
            <button
              ...
              className="p-2 min-w-[40px] min-h-[40px] flex items-center justify-center rounded-[18px] hover:bg-[#f5f5f5] text-[#6f6f6f] hover:text-[#0a0a0a] transition-colors cursor-pointer"
              title="Dismiss timer"
